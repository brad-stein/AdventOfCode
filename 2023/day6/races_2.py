...
def maxwaystowin(time: int, record: int):
    i=0
    total=0
    lowestwin=didiwin(time, record, 1)
    highestwin=didiwin(time, record, time-1)
...
pathtofile="./puzzel_6/race_set.txt"
...
total=maxwaystowin(int(time), int(record))
